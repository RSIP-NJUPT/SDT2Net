...
def get_args_parser():
    parser = argparse.ArgumentParser('SDT2Net training and evaluation script', add_help=False)
    ...
    # Learning rate schedule parametersi
...
def main(args):
    ...
    if 'deit' in args.model:
        SDT2Net.patch.deit(model, prune_granularity=args.granularity, merge_granularity=args.granularity)
    else:
